...
import math
from sort import *
cap=cv2.VideoCapture("/Users/poojithamm/PycharmProjects/Object-Detection-Yolo/pythonProject/Chapter-1/Videos/tourist_crossing_the_street (1080p).mp4")
...
while True:
    ...
    for i in resultsTracker:
        ...
        print(i)
        top_portion_y = y1
        bottom_portion_y = y1 + int(h/5)  # Adjust this to set the height of the blurred area
        roi_top = img[top_portion_y:bottom_portion_y, x1:x2]
        blurred_roi_top = cv2.GaussianBlur(roi_top, (31, 31), 0)  # You can adjust the kernel size for different blur intensity
        img[top_portion_y:bottom_portion_y, x1:x2] = blurred_roi_top
